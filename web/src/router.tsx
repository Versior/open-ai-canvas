...
const MCPMarketplacePage = lazy(() => import("@/pages/admin/mcp/mcp-marketplace-page"));
...
function devRoutes() {
    ...
    const AgentScrollReproLab = lazy(() => import("@/pages/dev/agent-scroll-repro-lab"));
    return [
        ...
        { path: "/dev/agent-scroll-repro", element: fullScreenDeferred(<AgentScrollReproLab />), errorElement: <RouteErrorPage /> },
    ];
}
        ...
        children: [
            ...
            { path: "/canvas/:id", element: <RequireAuth><CanvasProjectPage /></RequireAuth> },
            {
                ...
                children: [
                    ...
                    { path: "mcp", element: <MCPMarketplacePage /> },
